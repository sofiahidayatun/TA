...
<div class="row">
<div class="col-xs-12">
  <a href="{{url('Data_Jenisujian/add') }}">
    ...
    <tbody>
      @foreach($jenisujians as $jenisujian)
        <tr>
          ...
          <td>{{ $jenisujian->jenisujian }}</td> 
          <td>
            <div class="hidden-sm hidden-xs btn-group">
              <a href="{{ url('Data_Jenisujian/edit',$jenisujian->kode_jenisujian )}}">
                <button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>
              </a>
              <a href="{{ url('Data_Jenisujian/hapus',$jenisujian->kode_jenisujian )}}">
