...
@section ('content')
<form class="form-horizontal" role="form" action="{{ url('/Data_Admin/simpan')}}" method="POST" enctype="multipart/form-data">
<div class="col-md-6">
				...
				<tr>
					...
					<td>
						<div class="form-group">
		                  <input type="text" name="id_admin" class="form-control" placeholder="Enter ...">
		                </div>
	                </td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group">
		                  <input type="text" name="nama_admin" class="form-control" placeholder="Enter ...">
		                </div>
	                </td>
				</tr>
				<tr>
