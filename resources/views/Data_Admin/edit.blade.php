...
<form class="form-horizontal" role="form" action="{{ url('/Data_Admin/update',$admin->id )}}" method="POST" enctype="multipart/form-data">
<div class="col-md-6">
        ...
        <div class="box-body">
		    ...
		    <table>
				<tr>
					...
					<td>
						<div class="form-group">
		                  <input type="text" name="id_admin" class="form-control" value="{{ $admin->id }}" readonly>
		                </div>
	                </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="form-group">
			                  ...
			                  <input type="text" class="form-control pull-right" id="datepicker" name="tgl_lahir" value="{{ $admin->tgl_lahir }}">
			                </div>
		                </div>
		            </td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class="form-group">
		                  <input type="telepon" name="telepon" class="form-control" value="{{ $admin->telepon }}">
		                </div>
	                </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="form-group">
		                  <input type="file" id="inputgambar" name="foto" value="{{ $admin->foto }}" class="validate"/ >
		                </div>
	                </td>
				</tr>
				<tr>
	    ...
	    <div class="clearfix form-actions">
			<div class="col-md-offset-3 col-md-9">
				<input class="btn btn-info" type="submit" class="ace-icon fa fa-check bigger-110" value="Edit" id="bootbox-confirm">
					{{ csrf_field() }}
				&nbsp; &nbsp; &nbsp;
				<a href="{{url('Data_Admin')}}"><button class="btn" type="button">
