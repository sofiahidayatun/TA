...
class CreateArsipSoalTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('arsip_soal', function (Blueprint $table) {
            $table->char('kode_soal');
            $table->primary('kode_soal');
        ...
        //     $table ->onDelete('cascade');
        // });
        // Schema::table('arsip_soal', function ($table) {
        //     $table->softDeletes();
        // });
    }
    ...
    {
        Schema::dropIfExists('arsip_soal');
    }
}
